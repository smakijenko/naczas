...
let preferredMainRoute: [String : [PreferredRouteModel]] = [
    ...
    "409" : [PreferredRouteModel(routeName: "Custom409CmPółnocny", direction: "Cm.Północny-Brama Zach."), PreferredRouteModel(routeName: "Custom409BródnoPodgrodzie", direction: "Bródno-Podgrodzie")],
