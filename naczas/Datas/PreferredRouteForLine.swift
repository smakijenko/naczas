...
let preferredMainRoute: [String : [PreferredRouteModel]] = [
    ...
    "N45" : [PreferredRouteModel(routeName: "TP-LAZ", direction: "Lazurowa"), PreferredRouteModel(routeName: "TP-DWC", direction: "Dw.Centralny")],
    "N46" : [PreferredRouteModel(routeName: "TP-MML", direction: "Metro Młociny"), PreferredRouteModel(routeName: "TP-DWC", direction: "Dw.Centralny")],
    "N50" : [PreferredRouteModel(routeName: "TP-WAF", direction: "Waflowa"), PreferredRouteModel(routeName: "TP-WILW", direction: "Metro Wilanowska")],
    "N56" : [PreferredRouteModel(routeName: "TP-DZI", direction: "Dziekanów Leśny"), PreferredRouteModel(routeName: "TP-MML", direction: "Metro Młociny")],
    "N58" : [PreferredRouteModel(routeName: "CustomN58Skibińskiego", direction: "Skibińskiego"), PreferredRouteModel(routeName: "CustomN58MetroMłociny", direction: "Metro Młociny")],
    "N61" : [PreferredRouteModel(routeName: "TP-DWCS", direction: "Dw.Centralny"), PreferredRouteModel(routeName: "TP-RGLS", direction: "Głowackiego")],
    "N62" : [PreferredRouteModel(routeName: "CustomN62PKPWołomin", direction: "PKP Wołomin"), PreferredRouteModel(routeName: "CustomN62DwCentralny", direction: "Dw.Centralny")],
    "N63" : [PreferredRouteModel(routeName: "TP-CHT", direction: "Chotomów"), PreferredRouteModel(routeName: "TP-DWC", direction: "Dw.Centralny")],
    "N64" : [PreferredRouteModel(routeName: "TP-CHOSK", direction: "Choszczówka"), PreferredRouteModel(routeName: "TP-DWCKS", direction: "Dw.Centralny")],
    "N71" : [PreferredRouteModel(routeName: "CustomN72StareMiasto", direction: "Stare Miasto"), PreferredRouteModel(routeName: "CustomN72DwCentralny", direction: "Dw.Centralny")],
    "N81" : [PreferredRouteModel(routeName: "TP-DWC", direction: "Dw.Centralny"), PreferredRouteModel(routeName: "TP-SAR", direction: "Sarmacka")],
    "N83" : [PreferredRouteModel(routeName: "TP-DWC", direction: "Dw.Centralny"), PreferredRouteModel(routeName: "TO-PID", direction: "PKP Piaseczno")],
    "N85" : [PreferredRouteModel(routeName: "TP-CEN", direction: "Centrum"), PreferredRouteModel(routeName: "TO-PRU", direction: "Os.Staszica/Pętla")],
    "N86" : [PreferredRouteModel(routeName: "TP-DWC", direction: "Dw.Centralny"), PreferredRouteModel(routeName: "TO-MKA", direction: "Os.Kabaty")],
    "N88" : [PreferredRouteModel(routeName: "TP-CEN-P", direction: "Centrum"), PreferredRouteModel(routeName: "TP-JAN-I", direction: "Pl.Szwedzki")],
    "N91" : [PreferredRouteModel(routeName: "TP-WOW", direction: "Cm.Północny-Brama Zach."), PreferredRouteModel(routeName: "TO-DWC", direction: "Dw.Centralny")],
    "N95" : [PreferredRouteModel(routeName: "TX-GOR", direction: "Os.Górczewska"), PreferredRouteModel(routeName: "TX-DWC", direction: "Dw.Centralny")],
